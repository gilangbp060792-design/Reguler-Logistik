...
const Tracking = () => {
  ...
  return (
    <div className="animate-slide-up" style={{ background: '#f8fafc', minHeight: '100%', padding: '0 0 40px 0', margin: '-24px', width: 'calc(100% + 48px)' }}>
      ...
      <div style={{ padding: '32px 24px', display: 'grid', gridTemplateColumns: '300px 1fr', gap: '32px', maxWidth: '1200px', margin: '0 auto' }}>
        
        {/* Left Sidebar */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              <h2 style={{ fontSize: '18px', fontWeight: 700, margin: 0, color: '#0f172a' }}>Status Global</h2>
              <a href="#" style={{ fontSize: '12px', fontWeight: 600, color: '#0052cc', textDecoration: 'none' }}>Lihat Semua</a>
            </div>
            
            <div style={{ border: '1px solid #e2e8f0', borderRadius: '12px', background: 'white', padding: '16px' }}>
              
              <div style={{ display: 'flex', gap: '16px', alignItems: 'center', padding: '12px', background: '#f8fafc', borderRadius: '8px', marginBottom: '12px' }}>
                <div style={{ width: '48px', height: '48px', background: '#dbeafe', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#1e40af' }}>
                  <span className="material-symbols-outlined">local_shipping</span>
                </div>
                <div>
                  <div style={{ fontSize: '13px', color: '#475569', fontWeight: 500 }}>Dalam Perjalanan</div>
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
                    <span style={{ fontSize: '20px', fontWeight: 700, color: '#0f172a' }}>1,248</span>
                    <span style={{ fontSize: '12px', fontWeight: 600, color: '#16a34a' }}>+12%</span>
                  </div>
                </div>
              </div>

              <div style={{ display: 'flex', gap: '16px', alignItems: 'center', padding: '12px', background: '#f8fafc', borderRadius: '8px', marginBottom: '12px' }}>
                <div style={{ width: '48px', height: '48px', background: '#ffedd5', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#c2410c' }}>
                  <span className="material-symbols-outlined">two_wheeler</span>
                </div>
                <div>
                  <div style={{ fontSize: '13px', color: '#475569', fontWeight: 500 }}>Kurir Sedang Antar</div>
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
                    <span style={{ fontSize: '20px', fontWeight: 700, color: '#0f172a' }}>356</span>
                    <span style={{ fontSize: '12px', fontWeight: 600, color: '#16a34a' }}>+5%</span>
                  </div>
                </div>
              </div>

              <div style={{ display: 'flex', gap: '16px', alignItems: 'center', padding: '12px', background: '#fef2f2', borderRadius: '8px', border: '1px solid #fecaca' }}>
                <div style={{ width: '48px', height: '48px', background: '#fee2e2', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#b91c1c' }}>
                  <span className="material-symbols-outlined">warning</span>
                </div>
                <div>
                  <div style={{ fontSize: '13px', color: '#475569', fontWeight: 500 }}>Masalah/Kendala</div>
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
                    <span style={{ fontSize: '20px', fontWeight: 700, color: '#991b1b' }}>12</span>
                    <span style={{ fontSize: '12px', fontWeight: 600, color: '#dc2626' }}>-2</span>
                  </div>
                </div>
              </div>
          ...
          <div style={{ border: '1px solid #e2e8f0', borderRadius: '12px', background: 'white', padding: '24px', textAlign: 'center', overflow: 'hidden', position: 'relative' }}>
            <div style={{ fontSize: '12px', fontWeight: 600, color: '#475569', marginBottom: '8px' }}>Efisiensi Pengiriman</div>
            <div style={{ fontSize: '32px', fontWeight: 800, color: '#0052cc' }}>94.8%</div>
            {/* Fake wave graphic */}
            <svg viewBox="0 0 200 100" style={{ position: 'absolute', bottom: 0, left: 0, width: '100%', height: '50px', opacity: 0.2 }}>
              <path fill="none" stroke="#0052cc" strokeWidth="3" d="M0 50 Q 50 10 100 50 T 200 50" />
            </svg>
          </div>
        </div>
        ...
        <div>
          {trackedShipment ? (
            ...
            <div>
              ...
              {/* Map Area */}
              <div style={{ marginTop: '24px', border: '1px solid #e2e8f0', borderRadius: '12px', background: '#f1f5f9', height: '200px', position: 'relative', overflow: 'hidden' }}>
                <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', background: 'url("https://maps.googleapis.com/maps/api/staticmap?center=Jakarta&zoom=12&size=800x200&maptype=roadmap&style=feature:all|element:labels.text.fill|color:0x7c93a3&style=feature:administrative|element:geometry|visibility:off&style=feature:landscape|element:geometry.fill|color:0xfafbfc&style=feature:poi|visibility:off&style=feature:road|element:geometry.fill|color:0xdfe7ec&style=feature:road|element:geometry.stroke|color:0xc0ced8&style=feature:transit|visibility:off&style=feature:water|element:geometry.fill|color:0xc8d7d4") center/cover no-repeat', opacity: 0.6 }}></div>
                
                {/* Fake Map Markers */}
                <div style={{ position: 'absolute', top: '50%', left: '30%', transform: 'translate(-50%, -50%)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  <div style={{ background: '#0052cc', color: 'white', padding: '4px 8px', borderRadius: '4px', fontSize: '10px', fontWeight: 700, marginBottom: '4px' }}>LOKASI TERKINI</div>
                  <div style={{ width: '16px', height: '16px', background: '#0052cc', borderRadius: '50%', border: '3px solid white', boxShadow: '0 2px 4px rgba(0,0,0,0.2)' }}></div>
                </div>
                ...
                <div style={{ position: 'absolute', bottom: '16px', left: '16px', right: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                  <div style={{ background: 'white', padding: '12px 16px', borderRadius: '8px', display: 'flex', gap: '32px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
                    <div>
                      <div style={{ fontSize: '10px', fontWeight: 700, color: '#64748b', letterSpacing: '0.05em' }}>KURIR</div>
                      <div style={{ fontSize: '13px', fontWeight: 600, color: '#0f172a' }}>Rahmat Hidayat</div>
                    </div>
                    <div>
                      <div style={{ fontSize: '10px', fontWeight: 700, color: '#64748b', letterSpacing: '0.05em' }}>ESTIMASI TIBA</div>
                      <div style={{ fontSize: '13px', fontWeight: 600, color: '#0f172a' }}>Hari ini, 18:00</div>
                    </div>
                  </div>
                  <div style={{ width: '48px', height: '48px', background: '#ea580c', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', boxShadow: '0 4px 6px rgba(234,88,12,0.3)', cursor: 'pointer' }}>
